...
export default class DixieTabs {
  ...
  addTab(name, onSelectedCallback = null) {
    ...
    tab.className = 'dixie-tabs-tab tabber-deselected'; // Initial class for deselected tab
    tab.textContent = name;
    this.tabsContainer.appendChild(tab);

    const tabContent = document.createElement('div');
    tabContent.className = 'dixie-tabs-content';
  ...
  selectTab(index) {
    this.tabs.forEach((entry, tabIndex) => {
      ...
      entry.tab.classList.toggle('dixie-tabs-selected', isSelected);
      entry.tab.classList.toggle('dixie-tabs-deselected', !isSelected);
    });
